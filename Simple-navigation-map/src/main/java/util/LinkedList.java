...
public class LinkedList<T> extends Collection<T> {
    ...
    public Collection<T> swap(int i, int j) {
        ...
        if (f) {
            ...
            // Esta implementación usa 2 veces cada una de las funciones
            // get() y set(). Cada una tiene un tiempo de ejecución O(n).
            // Si se intercambian los elementos en posiciones consecutivas,
            // podría hacerse un solo recorrido hasta encontrar la i-ésima
            // posición.
            //
            T tmp = get(i);
            set(i, get(i + 1));
